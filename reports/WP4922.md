...
```
https://identifiers.org/wikipathways/WP4922 has an metabolite not linked to an interaction: Copper
https://identifiers.org/wikipathways/WP4922 has an metabolite not linked to an interaction: Heme A
https://identifiers.org/wikipathways/WP4922 has an metabolite not linked to an interaction: Heme B
https://identifiers.org/wikipathways/WP4922 has an metabolite not linked to an interaction: Heme O
```
